  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-secondary text-primary-foreground">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-[1200px] pt-12 pb-14 relative z-10">
      ...
      {/* Search Bar - Floating */}
      <div className="container mx-auto px-4 md:px-6 max-w-[1200px] relative z-20 -mt-7">
