  ...
  useEffect(() => {
    (async () => {
      ...
      const [
        ...
        supabase.from('hire_records').select('*', { count: 'exact', head: true }).gte('created_at', t30),
        supabase.from('hire_records').select('*', { count: 'exact', head: true }).gte('created_at', t60).lt('created_at', t30),
